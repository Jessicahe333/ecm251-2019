...
public class Debito {
    ...
    public Debito(int numeroCartao, int numeroConta, int ccv, String emissorCartao, String dataEmissão, String validade, String label, int senha){
        ...
        this.label = label;
        this.senha = senha;
        this.idCartao = Debito.idCartaoTotal;
        Debito.idCartaoTotal ++;
    }
